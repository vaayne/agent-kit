...
export function formatToolCall(
  ...
  switch (toolName) {
    case "bash": {
      ...
      return themeFg("muted", "$ ") + themeFg("toolOutput", truncateText(command, 60));
    }
    case "read": {
    ...
    default: {
      ...
      return themeFg("accent", toolName) + themeFg("dim", ` ${truncateText(argsText, 50)}`);
    }
  }
}
...
export function isResultError(result: Pick<SingleResult, "exitCode" | "stopReason">): boolean {
