...
The evidence protocol for deleting code. Read this when refine-code enters Entropy mode; Code and Architecture mode do not need it. The mode-choosing and core rule live in SKILL.md; this file is the protocol.
